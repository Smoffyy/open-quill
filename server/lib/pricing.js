const PRESETS = [
  { match: 'gpt-5.6-sol', label: 'GPT-5.6 Sol', in: 4, out: 20 },
  { match: 'gpt-5.6-terra', label: 'GPT-5.6 Terra', in: 2, out: 12 },
  { match: 'gpt-5.6-luna', label: 'GPT-5.6 Luna', in: 0.2, out: 1.2 },
  ...
  { match: 'gemini-3.8-flash', label: 'Gemini 3.8 Flash', in: 0.75, out: 3.75 },
  { match: 'gemini-3.7-flash', label: 'Gemini 3.7 Flash', in: 0.75, out: 3.75 },
  { match: 'gemini-3.6-flash', label: 'Gemini 3.6 Flash', in: 1.5, out: 7.5 },
  { match: 'gemini-3.5-flash', label: 'Gemini 3.5 Flash', in: 1.5, out: 9 },
  { match: 'gemini-3.5-flash-lite', label: 'Gemini 3.5 Flash-Lite', in: 0.3, out: 2.5 },
  { match: 'gemini-3.1-pro', label: 'Gemini 3.1 Pro', in: 2, out: 12 },
  ...
  { match: 'grok-4.7', label: 'Grok 4.7', in: 2, out: 6 },
  ...
  { match: 'deepseek-v4-pro', label: 'DeepSeek V4 Pro', in: 0.66, out: 1.98 },
  { match: 'deepseek-v4-flash', label: 'DeepSeek V4 Flash', in: 0.15, out: 0.60 },
