// Public surface of the file sandbox, keyed by workspace. Implementation lives in sandbox/:
//   paths   - workspace key, root resolution and the escape guard
...
export { SANDBOX_ROOT, dirFor, wsKey, projectKey, isProjectKey } from './sandbox/paths.js';
...
export { bash, winTranslate, childEnv } from './sandbox/shell.js';
