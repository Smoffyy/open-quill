const PRESETS = [
  ...
  { match: 'claude-sonnet-4-6', label: 'Claude Sonnet 4.6', in: 1.5, out: 7.50 },
  { match: 'claude-haiku-4-5-20251001', label: 'Claude Haiku 4.5', in: 0.5, out: 2.5 },
  ...
  { match: 'mistral-large', label: 'Mistral Large', in: 0.5, out: 1.5 },
  { match: 'mistral-small', label: 'Mistral Small', in: 0.1, out: 0.3 },
  { match: 'mistral-nemo', label: 'Mistral Nemo', in: 0.15, out: 0.15 },
  { match: 'codestral', label: 'Codestral', in: 0.3, out: 0.9 },

  { match: 'kimi-k2', label: 'Kimi K2', in: 0.95, out: 4.0 },
  { match: 'moonshot-v1-128k', label: 'Moonshot v1 128k', in: 2, out: 5 },
  { match: 'moonshot-v1-32k', label: 'Moonshot v1 32k', in: 2, out: 5 },
  { match: 'moonshot-v1-8k', label: 'Moonshot v1 8k', in: 2, out: 5 },

  { match: 'grok-4', label: 'Grok 4', in: 1.25, out: 2.5 },
  { match: 'grok-3-mini', label: 'Grok 3 mini', in: 1.25, out: 2.5 },
  { match: 'grok-3', label: 'Grok 3', in: 1.25, out: 2.5 },
...
export function presetList() {
  return PRESETS.map(p => ({ label: p.label, in: p.in, out: p.out }));
}
