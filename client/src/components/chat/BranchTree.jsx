...
export default function BranchTree({ chatId, onSelect, onJump, onClose, onChanged }) {
  ...
  return (
    <Dialog className="bt-modal" overlayClassName="bt-overlay" label={t('Branch map')} onClose={onClose}>
      <div className="bt-head">
        ...
        <CloseButton plain className="bt-x" onClick={onClose} />
      </div>
