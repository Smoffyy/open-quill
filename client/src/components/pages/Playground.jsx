...
import { Trash, Plus, Chevron, Panel, Gear, Copy, Check, Retry, Refresh, Stop, X, Flask, Sparkles, Expand, Pencil } from '../ui/icons.jsx';
import { KwargControl } from '../composer/ModelDropdown.jsx';
import { Switch } from '../ui/controls.jsx';
import { resolveKwargValues, kwargPayload, kwargValuesArr, defaultValueOf } from '../../lib/kwargs.js';
...
export default function Playground({ onClose }) {
  ...
  useLayer(true, () => { if (!streaming) onClose(); }, { modal: true });
  useLayer(promptFull, () => setPromptFull(false), { modal: true });
