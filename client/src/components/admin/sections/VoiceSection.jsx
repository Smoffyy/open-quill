  ...
  return (
    <>
      <Card title="Features" sub="Both buttons disappear from the composer entirely when turned off.">
        <SettingRow label="Microphone (dictation)" note="Adds a mic button to the input bar. Speech is transcribed into the message box, nothing sends until the user hits enter."
          on={!!settings.voiceMicEnabled} onToggle={() => setSettings(s => ({ ...s, voiceMicEnabled: !s.voiceMicEnabled }))} />
        <SettingRow last label="Voice calls" note="Adds a call button that opens a hands-free voice conversation panel. Spoken turns are saved to the chat like typed messages, and replies are read aloud."
