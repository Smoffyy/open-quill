...
export const ELEMENTS = [
  ...
  { id: 'modelDocsHead', label: tk('Model docs header'), cat: 'panels', sel: '.mdoc-header', parent: 'modelDocs', caps: ALL },
  { id: 'modelDocsNav', label: tk('Model docs sidebar'), cat: 'panels', sel: '.dnav', parent: 'modelDocs', caps: ALL },
