...
### Credits / shoutouts (Open-Source Software & Services)
...
- [SQLite3 Multiple Ciphers](https://github.com/utelle/SQLite3MultipleCiphers) - MIT - Encryption layer
- [SQLite](https://www.sqlite.org) - Public Domain - Database engine

#### Documents
- [pdfjs-dist](https://github.com/mozilla/pdf.js) - Apache-2.0 - PDF text extraction for memory and project files

pdf.js also provides the CMap tables and standard font data used by open-quill, allowing PDFs with predefined CJK encodings or non-embedded fonts to extract correctly without network access.
...
- [remark-gfm](https://github.com/remarkjs/react-markdown) - MIT - GitHub-flavored markdown
- [remark-math](https://github.com/remarkjs/react-markdown) - MIT - Math parsing in markdown
- [rehype-katex](https://github.com/remarkjs/react-markdown/tree/main/packages/rehype-katex) - MIT - KaTeX rendering
- [KaTeX](https://katex.org) - MIT - Math typesetting and fonts
- [highlight.js](https://highlightjs.org) - BSD-3-Clause - Syntax highlighting

#### Build Tooling
- [Vite](https://vite.dev) - MIT - Build tooling and development server
- [@vitejs/plugin-react](https://github.com/vitejs/vite-plugin-react) - MIT - React support for Vite
- [concurrently](https://github.com/open-cli-tools/concurrently) - MIT - Runs client and server together during development

#### Fonts
- [Fontsource](https://fontsource.org) - Bundled font packages
...
- [llama.cpp](https://github.com/ggml-org/llama.cpp) - Primary inference target. Used for `/props`, `/slots`, `/tokenize`, `/apply-template`, `timings_per_token`, and `return_progress` support.
...
- [SearXNG](https://github.com/searxng/searxng) - Web search backend
- [whisper.cpp](https://github.com/ggml-org/whisper.cpp) - Local speech-to-text
- [faster-whisper-server](https://github.com/fedirz/faster-whisper-server) - OpenAI-compatible speech-to-text server
- [Speaches](https://github.com/speaches-ai/speaches) - OpenAI-compatible speech-to-text server
- [Piper](https://github.com/rhasspy/piper) - Local text-to-speech
- [Kokoro-FastAPI](https://github.com/remsky/Kokoro-FastAPI) - Local text-to-speech server
- [openedai-speech](https://github.com/matatonic/openedai-speech) - OpenAI-compatible text-to-speech server
- [Model Context Protocol](https://modelcontextprotocol.io) - Tool integration standard for MCP support
